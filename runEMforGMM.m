function [model,loglik] = runEMforGMM( data, K, Niter, savefilename, seed, model)
% Run EM algorithm for fitting the Gaussian mixture model with K components
% AUTHOR: Mike Hughes (mike@michaelchughes.com)
% INPUT
%   data  : NxD data matrix (each row is one observation to cluster)
